...
export type ConnectorId = OsvaId<"ConnectorId">;
export type ConnectorVersionId = OsvaId<"ConnectorVersionId">;
...
export type MemoryNamespaceId = OsvaId<"MemoryNamespaceId">;
export type EvaluationSuiteId = OsvaId<"EvaluationSuiteId">;
export type EvaluationSuiteVersionId = OsvaId<"EvaluationSuiteVersionId">;
export type EvaluationCaseId = OsvaId<"EvaluationCaseId">;
export type EvaluationRunId = OsvaId<"EvaluationRunId">;
export type EvaluationCaseResultId = OsvaId<"EvaluationCaseResultId">;
